...
// let preguntarEdad = prompt('Cuanto tenes?');

// preguntarEdad >= 18 ? console.log('podes ingresar al boliche') : console.log('No podes ingresar al boliche');
...
// nuestroTitulo.textContent = 'Gordita'
