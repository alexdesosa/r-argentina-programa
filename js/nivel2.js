...
let comidasFavoritas = ["Pizza", "Hamburguesa", "Perros", "Caca"];
...
const armasPeligrosas = ["Pistola", "Chuchillo", "Arma Blanca"];

armasPeligrosas[1] = "Bate";
...
// const juegosFavoritos = ["Elder Ring", "Posadas", "Carlos", "Raul"];

// for(i=0; i < juegosFavoritos.length; i++){
//     console.log(juegosFavoritos[i]);
// }
